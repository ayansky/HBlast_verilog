...
create_clock -period 2.188 [get_ports sys_clk_p]
...
set_property PACKAGE_PIN M14 [get_ports {ddr3_dq[0]}]
...
set_property PACKAGE_PIN L14 [get_ports {ddr3_dq[1]}]
...
set_property PACKAGE_PIN N13 [get_ports {ddr3_dq[2]}]
...
set_property PACKAGE_PIN M13 [get_ports {ddr3_dq[3]}]
...
set_property PACKAGE_PIN N15 [get_ports {ddr3_dq[4]}]
...
set_property PACKAGE_PIN N14 [get_ports {ddr3_dq[5]}]
...
set_property PACKAGE_PIN M12 [get_ports {ddr3_dq[6]}]
...
set_property PACKAGE_PIN C15 [get_ports {ddr3_ck_p[0]}]

# PadFunction: IO_L3N_T0_DQS_39 
set_property VCCAUX_IO HIGH [get_ports {ddr3_ck_n[0]}]
set_property SLEW FAST [get_ports {ddr3_ck_n[0]}]
set_property IOSTANDARD DIFF_SSTL15 [get_ports {ddr3_ck_n[0]}]
set_property PACKAGE_PIN C14 [get_ports {ddr3_ck_n[0]}]
...
set_property LOC PLLE2_ADV_X1Y9 [get_cells -hier -filter {NAME =~ */u_ddr3_infrastructure/plle2_i}]
set_property LOC MMCME2_ADV_X1Y9 [get_cells -hier -filter {NAME =~ */u_ddr3_infrastructure/gen_mmcm.mmcm_i}]
